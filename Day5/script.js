...
function onEdit(td)
{if(confirm("Are you want to upadate your details")){
...
function isValid() {
  ...
  if (
    ...
    alert("Please enter valid input. Ensure all text fields are alphabetical and age is between 18 and 90.");
    return false;
  }
}
...
function validateAge(age) {
  ...
  return containsOnlyDigits(age) && ageNum >= 18 && ageNum <= 90;
}
